...
public class Player_Aim : MonoBehaviour
{
    ...
    public static Player_Aim instance;
    private void Awake()
    {
        instance = this;
    }
    ...
    public void EnableAimLase(bool enable) => aimLaser.enabled = enable;     
