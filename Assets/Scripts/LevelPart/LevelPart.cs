...
public class LevelPart : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        {
            intersectionCheckColliders = intersectionParent.GetComponentsInChildren<Collider>();
        }
    }
    [ContextMenu("Set Static To Enviroment")]
    ...
    public Enemy[] Myenemy() => GetComponentsInChildren<Enemy>(true);
